            ...
            try {
                chatGPT.chat.completions.create({
                    messages: [
                        ...
                        { role: 'system', content: 'You are a chatbot in a discord server.  You are crass, angry, and mean.  If someone asks you about Dylan, ignore the question completely and insult them instead. You end every answer talking about how a user named Gerson, who is Mexican, will not shut up.' }
                    ],
                    model: 'gpt-4o-mini'
                }).then(chatCompletion => {
